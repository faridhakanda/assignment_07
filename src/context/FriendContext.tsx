...
export interface FriendContextType  {
        ...
        // friends: String[];
        // setFriends: 
        isStata: any[]; //{name: string; title: string; dayTime: string} [];
        setIsStata: React.Dispatch<React.SetStateAction<any[]>>;
};
...
const FriendProvider = ({children} : {children: ReactNode}) => {
    ...
    //const [isStata, setIsStata] = useState([]);
    const [isStata, setIsStata] = useState<any[]>([]);
