        ...
        <div className='bg-[#244D3F]'>
            <div className='w-280 mx-auto text-center'>
                <div className='pt-20 '>
                    ...
                    <Image className='flex mx-auto py-2' src={KeenKeeper} alt="keenkeeper text logo" width="auto" height="auto" />
                    ...
                    <div className='flex mx-auto justify-center space-x-2'>
                        <Image src={Instragram} alt="Instragram Icon" width="auto" hegiht="auto" />
                        <Image src={Facebook} alt="Facebook Icon" width="auto" height="auto" />
                        <Image src={X} alt="X Icon" width="auto" height="auto" />
                    </div>
                </div>
